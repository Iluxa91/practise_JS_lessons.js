...
let topStudents = deepCopyStudents.sort((a, b) => b.scores - a.scores).splice(0, deepCopyStudents.length - 3,)
...
const addFriends = (students) => {
    return students.map(st=>({...st,
       friends:[...students].filter(el => el.name!==st.name)}))
}
